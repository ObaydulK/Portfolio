...
const Footers = () => {
    ...
    return (
        <>
            <Footer container className="bg-[#343a40]  p-10  font-serif " >
                <div className=" w-full  ">
                    ...
                    <div className="grid  grid-flow-col justify-stretch space-x-4 ">
                        <from className=" grid lg:grid-flow-col lg:grid-cols-2 gap-8 justify-center space-x-4">
                            <input className="  rounded text-black  " type="text" placeholder="YonMail@gmail.com" id="" ref={inputRef} />
                    ...
                    <div className=" grid lg:grid-flow-col   lg:justify-between text-center lg:py-10 md:py-5     md:flex md:grid-cols-1            sm:flex sm:justify-between sm:mt-4 sm:grid-cols-1 sm:gap-6">
                        {/* this is contact phone part  */}
                        <div className=" grid  grid-flow-col lg:grid-cols-2 py-4  ">
